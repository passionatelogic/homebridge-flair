...
exports.FlairVentPlatformAccessory = exports.VentAccessoryType = void 0;
const utils_1 = require("./utils");
var VentAccessoryType;
(function (VentAccessoryType) {
    VentAccessoryType["WindowCovering"] = "windowCovering";
    VentAccessoryType["Fan"] = "fan";
    VentAccessoryType["AirPurifier"] = "airPurifier";
    VentAccessoryType["Hidden"] = "hidden";
})(VentAccessoryType || (exports.VentAccessoryType = VentAccessoryType = {}));
/**
 * Platform Accessory
 * An instance of this class is created for each accessory your platform registers
 * Each accessory may expose multiple services of different service types.
 */
class FlairVentPlatformAccessory {
    platform;
    accessory;
    fanService;
    windowService;
    ...
    constructor(platform, accessory, client) {
        ...
        this.client = client;
        this.accessoryType = this.platform.config.ventAccessoryType;
    ...
    updateVentReadingsFromVent(vent) {
        ...
        switch (this.accessoryType) {
            case VentAccessoryType.WindowCovering:
                ...
                this.mainService.updateCharacteristic(this.platform.Characteristic.PositionState, this.platform.Characteristic.PositionState.STOPPED);
                break;
            case VentAccessoryType.AirPurifier:
...
exports.FlairVentPlatformAccessory = FlairVentPlatformAccessory;
//# sourceMappingURL=ventPlatformAccessory.js.map